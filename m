...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 207D71B2EE6
	for <lists+openwrt-devel@lfdr.de>; Tue, 21 Apr 2020 20:19:45 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=ivLXS6Ew2iqT4CihhGF4fKZdKTyXycHBTMQyPPfcuYM=; b=qOJ907lTiPethKHCsuELmeW01
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jQxUl-00036a-7J; Tue, 21 Apr 2020 18:19:43 +0000
Received: from mail.redfish-solutions.com ([45.33.216.244])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jQxUX-00036H-J9
 for openwrt-devel@lists.openwrt.org; Tue, 21 Apr 2020 18:19:31 +0000
Received: from macbook2.redfish-solutions.com (macbook2.redfish-solutions.com
 [192.168.1.39]) (authenticated bits=0)
 by mail.redfish-solutions.com (8.15.2/8.15.2) with ESMTPSA id 03LIJSqs022431
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Tue, 21 Apr 2020 12:19:28 -0600
From: Philip Prindeville <philipp_subx@redfish-solutions.com>
Message-Id: <B41AB920-138B-4261-B383-FBEC263B62A3@redfish-solutions.com>
Content-Type: multipart/mixed;
 boundary="Apple-Mail=_F1DCDDDB-0C0F-4BA0-AA61-7EE687350E89"
Mime-Version: 1.0 (Mac OS X Mail 13.4 \(3608.80.23.2.2\))
Date: Tue, 21 Apr 2020 12:19:28 -0600
...
X-Spam-Note: CRM114 run bypassed due to message size (255286 bytes)
X-Spam-Score: 0.0 (/)
...
--Apple-Mail=_F1DCDDDB-0C0F-4BA0-AA61-7EE687350E89
...
> On Apr 20, 2020, at 1:18 AM, Petr =C5=A0tetiar <ynezz@true.cz> wrote:
>=20
> Philip Prindeville <philipp_subx@redfish-solutions.com> [2020-04-19 =
21:47:19]:
>=20
> Hi,
>=20
>> I just rebased to openwrt master today, and tried to rebuild from =
scratch but I=E2=80=99m getting:
>=20
> So perhaps something related to your local changes/setup/tree? =
Buildbots are
> green, I dont remember seeing broken x86/64 build and I build and run =
test it
> with every kernel bump. It's incremental local build and build from =
scratch on
> CI.
>=20
> -- ynezz
...
Easily reproducible.  I=E2=80=99m using:
...
CONFIG_GRUB_BOOTOPTS="nmi_watchdog=1 crashkernel=256M"
...
CONFIG_TARGET_ROOTFS_PARTSIZE=226
...
CONFIG_TARGET_PREINIT_TIMEOUT=0
# CONFIG_TARGET_PREINIT_SHOW_NETMSG is not set
CONFIG_TARGET_PREINIT_SUPPRESS_FAILSAFE_NETMSG=y
CONFIG_TARGET_PREINIT_IFNAME=""
CONFIG_TARGET_PREINIT_IP="192.168.1.99"
...
CONFIG_VERSION_MANUFACTURER_URL="http://www.redfish-solutions.com/"
...
CONFIG_BUSYBOX_CONFIG_FEATURE_CATN=y
...
CONFIG_BUSYBOX_CONFIG_FEATURE_CHOWN_LONG_OPTIONS=y
...
CONFIG_BUSYBOX_CONFIG_FEATURE_CP_LONG_OPTIONS=y
# CONFIG_BUSYBOX_CONFIG_FEATURE_CP_REFLINK is not set
...
CONFIG_BUSYBOX_CONFIG_UNAME_OSNAME=""
...
# CONFIG_BUSYBOX_CONFIG_W is not set
CONFIG_BUSYBOX_CONFIG_USERS=y
...
# CONFIG_BUSYBOX_CONFIG_FEATURE_GPT_LABEL is not set
...
CONFIG_BUSYBOX_CONFIG_FEATURE_CROND_D=y
...
CONFIG_BUSYBOX_CONFIG_VOLNAME=y
...
CONFIG_BUSYBOX_CONFIG_IPCALC=y
CONFIG_BUSYBOX_CONFIG_FEATURE_IPCALC_LONG_OPTIONS=y
CONFIG_BUSYBOX_CONFIG_FEATURE_IPCALC_FANCY=y
...
CONFIG_BUSYBOX_CONFIG_FEATURE_UPTIME_UTMP_SUPPORT=y
...
# CONFIG_BUSYBOX_CONFIG_FEATURE_KLOGD_KLOGCTL is not set
...
CONFIG_PACKAGE_disable-openssh-password-login=y
CONFIG_PACKAGE_files-overlay=y
...
CONFIG_PACKAGE_root-passwd=y
CONFIG_TARGET_ROOT_PASSWD="eaIs9WUQbQn2w"
...
CONFIG_PACKAGE_kmod-i2c-algo-pca=y
...
# LED modules
#
# CONFIG_PACKAGE_kmod-leds-apu2 is not set
...
CONFIG_PACKAGE_kmod-itco-wdt=y
...
CONFIG_PACKAGE_perlbase-blib=y
...
CONFIG_PACKAGE_perlbase-sdbm-file=y
CONFIG_PACKAGE_perlbase-search=y
...
CONFIG_PACKAGE_perlbase-universal=y
# CONFIG_PACKAGE_perlbase-user is not set
CONFIG_PACKAGE_perlbase-utf8=y
CONFIG_PACKAGE_perlbase-version=y
...
# CONFIG_PACKAGE_libdbd-mysql is not set
# CONFIG_PACKAGE_libdbd-pgsql is not set
# CONFIG_PACKAGE_libdbd-sqlite3 is not set
...
# CONFIG_BIND_LIBJSON is not set
# CONFIG_BIND_LIBXML2 is not set
...
# CONFIG_LLDPD_WITH_JSON is not set
...
# Configuration
#
# CONFIG_BWMNG_CONFIGFILE is not set
# CONFIG_BWMNG_HTML is not set
# CONFIG_BWMNG_CSV is not set
CONFIG_BWMNG_EXTENDEDSTATS=y
# CONFIG_BWMNG_LIBNCURSES is not set
CONFIG_BWMNG_TIME=y
# CONFIG_BWMNG_GETOPT_LONG is not set
...
# CONFIG_PACKAGE_gnupg-utils is not set
...
CONFIG_PACKAGE_collectd-mod-filecount=y
...
# CONFIG_PACKAGE_collectd-mod-iwinfo is not set
...
# CONFIG_LOGROTATE_ACL is not set
