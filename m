...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 90FF1184CA5
	for <lists+openwrt-devel@lfdr.de>; Fri, 13 Mar 2020 17:40:19 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=yDZUMT2XYLnompQtuBu0VfqU5y5kuL29Dh4dQoX0x5Q=; b=QkbV8hPfAD+X+UL8233U4dDQ0
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jCnM6-0008Vv-8G; Fri, 13 Mar 2020 16:40:14 +0000
Received: from mxout01.bytecamp.net ([212.204.60.217])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jCnLs-0008Ax-BH
 for openwrt-devel@lists.openwrt.org; Fri, 13 Mar 2020 16:40:02 +0000
Received: by mxout01.bytecamp.net (Postfix, from userid 1001)
 id 8B46C49BB6; Fri, 13 Mar 2020 17:39:57 +0100 (CET)
Received: from mail.bytecamp.net (mail.bytecamp.net [212.204.60.9])
 by mxout01.bytecamp.net (Postfix) with ESMTP id 4DEC549BB2
 for <openwrt-devel@lists.openwrt.org>; Fri, 13 Mar 2020 17:39:56 +0100 (CET)
Received: (qmail 76633 invoked from network); 13 Mar 2020 17:39:56 +0100
Received: from unknown (HELO ?10.11.12.7?) (jo%wwsnet.net@95.90.36.22)
 by mail.bytecamp.net with ESMTPS (AES128-SHA encrypted);
 13 Mar 2020 17:39:56 +0100
...
Message-ID: <bc5d7630-f090-f108-e6a8-adf31a62d471@wwsnet.net>
Date: Fri, 13 Mar 2020 17:39:51 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.1
MIME-Version: 1.0
In-Reply-To: <CACfEFw96zEJ3Zp+oVjJ_4M=AW5_3cZdAuEV+2A5+SNmUXdRmWg@mail.gmail.com>
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200313_094000_543500_95CE0D97 
...
Content-Type: multipart/mixed; boundary="===============6748261774293019243=="
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="4LvaiDCE3rEfJqkOAaRarWGBfq2buOlL7"

This is an OpenPGP/MIME signed message (RFC 4880 and 3156)
--4LvaiDCE3rEfJqkOAaRarWGBfq2buOlL7
Content-Type: multipart/mixed; boundary="HrjbKWtcCX4p00k5oBw77U1Z7pOiZWu9G";
...
--HrjbKWtcCX4p00k5oBw77U1Z7pOiZWu9G
...
I don't see any immediate concerns. You can trigger resource intensive ca=
lls
...
uci set uhttpd.main.http_keepalive=3D0 or alternatively uhttpd -k 0

> What happens to RAM and CPU usage when there are multiple tabs open wit=
h
> keep-alive on?
...
Thats not a scientific benchmark though. In general you trade CPU (TLS se=
tup,
...
because there's less active TLS sessions at every point in time. And almo=
st no
...

=2loT
-----END PGP SIGNATURE-----
