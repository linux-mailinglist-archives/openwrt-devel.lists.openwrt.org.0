...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 11A8B1751DF
	for <lists+openwrt-devel@lfdr.de>; Mon,  2 Mar 2020 03:45:00 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=nc9/Ng5JTwmTwaGbp3jhH/DN5EmiOUwYY/DXDKSoBfc=; b=ueSOw5YrSbU6tMUKKx3xa2RhQ
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j8b4h-0002xm-Lk; Mon, 02 Mar 2020 02:44:55 +0000
Received: from mail-wr1-x444.google.com ([2a00:1450:4864:20::444])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j8b4V-0002xK-NY
 for openwrt-devel@lists.openwrt.org; Mon, 02 Mar 2020 02:44:46 +0000
Received: by mail-wr1-x444.google.com with SMTP id y17so10593175wrn.6
 for <openwrt-devel@lists.openwrt.org>; Sun, 01 Mar 2020 18:44:43 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=date:from:to:cc:subject:in-reply-to:message-id:references
 :mime-version; bh=MD2wHl35YORStanSZpzhwlUQ94XHBkd9lmuNGMQUsOA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:in-reply-to:message-id
 :references:mime-version;
 bh=MD2wHl35YORStanSZpzhwlUQ94XHBkd9lmuNGMQUsOA=;
 b=
X-Gm-Message-State: APjAAAU+5Xu7O/wjY63YhcJrOwI13vqlxFZan7YOdUUfj/xN8N975kyJ
 e2RKCCv+nTUbMzTy/PRgkA5IdcLm
X-Google-Smtp-Source: APXvYqwquPwMz0CXBf12LQVmFxia/H/0d6HBlKx+bshMfHbTJzfM9vkBT+PflZfofUHsnbod2lDWDg==
X-Received: by 2002:adf:ce8b:: with SMTP id r11mr20634695wrn.347.1583117081252; 
 Sun, 01 Mar 2020 18:44:41 -0800 (PST)
Received: from mStation (host224-250-dynamic.8-87-r.retail.telecomitalia.it.
 [87.8.250.224])
 by smtp.gmail.com with ESMTPSA id z5sm7656022wml.48.2020.03.01.18.44.39
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 01 Mar 2020 18:44:40 -0800 (PST)
Date: Mon, 2 Mar 2020 03:44:38 +0100 (CET)
From: Enrico Mioso <mrkiko.rs@gmail.com>
X-X-Sender: mrkiko@mStation.localdomain
To: openwrt-devel@lists.openwrt.org
In-Reply-To: <alpine.LNX.2.21.99999.353.2003020317090.1019877@mStation.localdomain>
Message-ID: <alpine.LNX.2.21.99999.353.2003020342120.1019928@mStation.localdomain>
References: <alpine.LNX.2.21.99999.353.2003020317090.1019877@mStation.localdomain>
MIME-Version: 1.0
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200301_184443_807853_6EADCB72 
...
Ok guys, the error rpeats itself, and jffs2 seems to get corrupted. And even erasing the mtd6 device fails at some point.
Even the F2FS filesystem on the internal SSD does corrupt. This remembers me the issue I was having when using the GnuBee PC 1 some time ago.
...
> rwdata, 1048K rodata, 1236K init, 253K bss, 13312K reserved, 0K cma-reserved, 
> 262144K highmem)
...
> bytes.
> [    0.105975] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 32 
> bytes
...
> bytes.
> [    0.206021] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 32 
> bytes
...
> bytes.
> [    0.287165] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 32 
> bytes
...
> [    0.379150] clocksource: jiffies: mask: 0xffffffff max_cycles: 0xffffffff, 
...
> [    1.991433] pci_bus 0000:00: No busn resource found for root bus, will use 
> [bus 00-ff]
...
> [    7.389239] ahci 0000:03:00.0: AHCI 0001.0200 32 slots 2 ports 6 Gbps 0x3 
> impl IDE mode
> [    7.397240] ahci 0000:03:00.0: flags: 64bit ncq sntf stag led clo pmp pio 
> slum part ccc sxs [    7.407968] scsi host0: ahci
...
> [    8.141072] scsi 1:0:0:0: Direct-Access     ATA      WDC WDS120G2G0A- 0000 
> PQ: 0 ANSI: 5
...
> [    8.199866] xhci-mtk 1e1c0000.xhci: 1e1c0000.xhci supply vusb33 not found, 
> using dummy regulator
> [    8.208828] xhci-mtk 1e1c0000.xhci: xHCI Host Controller
> [    8.214173] xhci-mtk 1e1c0000.xhci: new USB bus registered, assigned bus 
> number 1
> [    8.230756] xhci-mtk 1e1c0000.xhci: hcc params 0x01401198 hci version 0x96 
> quirks 0x0000000000210010
...
> [    8.274792] usb usb2: We don't know the algorithms for LPM for this host, 
> disabling LPM.
...
> [    8.416874] mmcblk0: mmc0:0001 SD16G 14.5 GiB [    8.422931]  mmcblk0: p1
