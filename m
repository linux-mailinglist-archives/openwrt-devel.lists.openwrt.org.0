...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id CCEFF1045FE
	for <lists+openwrt-devel@lfdr.de>; Wed, 20 Nov 2019 22:45:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=cBjYUiR1ZJIBxWvq7xY3uqadTeNpwmghvoVxYqhOGgw=; b=rt4B0EhhPUAoD8
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iXXnM-0000Jn-H8; Wed, 20 Nov 2019 21:45:52 +0000
...
Received: from meh.true.cz (meh.true.cz [108.61.167.218])
 ...
 by smtp-out.xnet.cz (Postfix) with ESMTPSA id 784794ADD;
 Wed, 20 Nov 2019 22:44:03 +0100 (CET)
Received: by meh.true.cz (OpenSMTPD) with ESMTP id 19982418;
 Wed, 20 Nov 2019 22:43:53 +0100 (CET)
From: =?UTF-8?q?Petr=20=C5=A0tetiar?= <ynezz@true.cz>
To: openwrt-devel@lists.openwrt.org
Date: Wed, 20 Nov 2019 22:43:51 +0100
Message-Id: <20191120214353.27652-9-ynezz@true.cz>
In-Reply-To: <20191120214353.27652-1-ynezz@true.cz>
References: <20191120214353.27652-1-ynezz@true.cz>
MIME-Version: 1.0
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191120_134405_589799_D9E6E64A 
...
Subject: [OpenWrt-Devel] [PATCH v2 libubox 08/10] jshn: jshn_parse: fix
 leaks of memory pointed to by 'obj'
