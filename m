...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 19B7E1460CF
	for <lists+openwrt-devel@lfdr.de>; Thu, 23 Jan 2020 03:57:16 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=dNXpdikPVY1SejJajLzXsMGGAo5FssYicn8odMB2fHM=; b=Tegh5TGFFEWKXr
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iuSgC-0002oF-MC; Thu, 23 Jan 2020 02:57:12 +0000
Received: from mail-pg1-x532.google.com ([2607:f8b0:4864:20::532])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iuSg3-0002ne-Gw
 for openwrt-devel@lists.openwrt.org; Thu, 23 Jan 2020 02:57:06 +0000
Received: by mail-pg1-x532.google.com with SMTP id z124so578901pgb.13
 for <openwrt-devel@lists.openwrt.org>; Wed, 22 Jan 2020 18:57:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:subject:date:message-id:mime-version
 :content-transfer-encoding;
 bh=o3qUECKW0xVtfNupDozXv1QvkEFaaSqOHMK5Q4KPo4o=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=o3qUECKW0xVtfNupDozXv1QvkEFaaSqOHMK5Q4KPo4o=;
 b=
X-Gm-Message-State: APjAAAXJ3qIZYnw257+BV/3fInNCGO5V6+CioLq4rTAlLlicS8z80+WN
 TXgBi8OmtL1Rmxf01W4yXiPc6C3H
X-Google-Smtp-Source: APXvYqyWVw8DrPi5gxqr358Iurs/3Qtn972tflDGN3yxNoDT5b6WlJ0EKJbjTzic+wJm35mEOEVh+A==
X-Received: by 2002:a63:eb02:: with SMTP id t2mr1590074pgh.289.1579748221848; 
 Wed, 22 Jan 2020 18:57:01 -0800 (PST)
Received: from localhost.localdomain ([69.42.0.214])
 by smtp.gmail.com with ESMTPSA id d2sm354323pjv.18.2020.01.22.18.57.00
 for <openwrt-devel@lists.openwrt.org>
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 22 Jan 2020 18:57:01 -0800 (PST)
From: Rosen Penev <rosenp@gmail.com>
To: openwrt-devel@lists.openwrt.org
Date: Wed, 22 Jan 2020 18:56:58 -0800
Message-Id: <20200123025658.1416676-1-rosenp@gmail.com>
X-Mailer: git-send-email 2.24.1
MIME-Version: 1.0
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200122_185703_598518_7F4D2C1B 
...
Subject: [OpenWrt-Devel] [PATCHv3] mdadm: revised mdadm config & init logic
...
index 64a50b35de..eb323ecad0 100644
...
+    [ -x /usr/sbin/sendmail ] && [ ! -e "$mail_program" ] && {
