...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 182DC7D03D
	for <lists+openwrt-devel@lfdr.de>; Wed, 31 Jul 2019 23:45:14 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=C5T3+VRBeDgNOg57F3bvxd4YDwcervXsmK1Lkkfncd8=; b=COJxYh6IQTL6OB
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hswPI-00009N-H3; Wed, 31 Jul 2019 21:45:12 +0000
Received: from mo6-p00-ob.smtp.rzone.de ([2a01:238:20a:202:5300::4])
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1hswPB-0007ux-Hg
 for openwrt-devel@lists.openwrt.org; Wed, 31 Jul 2019 21:45:07 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1564609503;
 s=strato-dkim-0002; d=heimpold.de;
 h=Message-Id:Date:Subject:Cc:To:From:X-RZG-CLASS-ID:X-RZG-AUTH:From:
 Subject:Sender;
 bh=1pVXvwTJjqKTvwqIqi3w/fHnBHA5x5vQAm8mxtDIOOE=;
 b=
...
Received: from tonne.mhei.heimpold.itr
 ...
 with ESMTPSA id m00609v6VLj33Lb
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (curve secp521r1 with
 521 ECDH bits, eq. 15360 bits RSA))
 (Client did not present a certificate);
 Wed, 31 Jul 2019 23:45:03 +0200 (CEST)
Received: from kerker.mhei.heimpold.itr (kerker.mhei.heimpold.itr
 [192.168.8.1])
 by tonne.mhei.heimpold.itr (Postfix) with ESMTP id 2804B14A8EE;
 Wed, 31 Jul 2019 23:45:02 +0200 (CEST)
From: Michael Heimpold <mhei@heimpold.de>
To: openwrt-devel@lists.openwrt.org
Date: Wed, 31 Jul 2019 23:45:00 +0200
Message-Id: <20190731214500.11740-1-mhei@heimpold.de>
X-Mailer: git-send-email 2.17.1
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190731_144505_746654_B8FEE5A9 
...
X-Spam-Report: SpamAssassin version 3.4.2 on bombadil.infradead.org summary:
 ...
 low trust [2a01:238:20a:202:5300:0:0:4 listed in]
 [list.dnswl.org]
...
Subject: [OpenWrt-Devel] [PATCH] mxs: add support and switch to kernel 4.19
