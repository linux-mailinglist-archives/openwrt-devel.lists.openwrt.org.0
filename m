...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id C70241045F8
	for <lists+openwrt-devel@lfdr.de>; Wed, 20 Nov 2019 22:44:32 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=Ox4IziSo1DQfeT1sw5PQdth6dYTpdnbE7nXovzT/PWQ=; b=CsLc8S67RbHMOe
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iXXm2-00061n-6w; Wed, 20 Nov 2019 21:44:30 +0000
Received: from smtp-out.xnet.cz ([178.217.244.18])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iXXla-0005nP-HU
 for openwrt-devel@lists.openwrt.org; Wed, 20 Nov 2019 21:44:04 +0000
Received: from meh.true.cz (meh.true.cz [108.61.167.218])
 (Authenticated sender: petr@true.cz)
 by smtp-out.xnet.cz (Postfix) with ESMTPSA id 125AA4AD6;
 Wed, 20 Nov 2019 22:44:01 +0100 (CET)
Received: by meh.true.cz (OpenSMTPD) with ESMTP id a6734339;
 Wed, 20 Nov 2019 22:43:50 +0100 (CET)
From: =?UTF-8?q?Petr=20=C5=A0tetiar?= <ynezz@true.cz>
To: openwrt-devel@lists.openwrt.org
Date: Wed, 20 Nov 2019 22:43:45 +0100
Message-Id: <20191120214353.27652-3-ynezz@true.cz>
In-Reply-To: <20191120214353.27652-1-ynezz@true.cz>
References: <20191120214353.27652-1-ynezz@true.cz>
MIME-Version: 1.0
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191120_134402_726715_D1B45EB2 
...
Subject: [OpenWrt-Devel] [PATCH v2 libubox 02/10] enable extra compiler
 checks
