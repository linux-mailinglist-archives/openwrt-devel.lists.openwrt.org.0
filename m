...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FBC61751F5
	for <lists+openwrt-devel@lfdr.de>; Mon,  2 Mar 2020 03:53:04 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=kEt6/TX0EhiZWXD3U/jWQKeX+LFn3InkdaJtpkhK6tE=; b=c9X8APdkAliA82TfuXsB7qEt8
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j8bCQ-0007Fd-Uf; Mon, 02 Mar 2020 02:52:55 +0000
Received: from mail-wm1-x344.google.com ([2a00:1450:4864:20::344])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j8bCF-0007Et-GK
 for openwrt-devel@lists.openwrt.org; Mon, 02 Mar 2020 02:52:46 +0000
Received: by mail-wm1-x344.google.com with SMTP id c24so1682512wml.4
 for <openwrt-devel@lists.openwrt.org>; Sun, 01 Mar 2020 18:52:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=date:from:to:cc:subject:in-reply-to:message-id:references
 :mime-version; bh=ism9TtRkT4/wTmMnpW8YmfVqMHXNV1Xbi4AJE5mTUkI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:in-reply-to:message-id
 :references:mime-version;
 bh=ism9TtRkT4/wTmMnpW8YmfVqMHXNV1Xbi4AJE5mTUkI=;
 b=
X-Gm-Message-State: APjAAAV/7iWj5HFpy1b0NBK7idssHXAqCiNOp04de7APSKw54vZuYydJ
 LR90DHZse2ZyJGP2aqvn2AdRnSgx
X-Google-Smtp-Source: APXvYqy6Gai3iKfoIeGisND9s8NzKmsEviCfiah6uAlD4uaZE7itHBIimfOl3Q7oNHwNypjkYmOwYg==
X-Received: by 2002:a7b:c750:: with SMTP id w16mr16587811wmk.46.1583117561157; 
 Sun, 01 Mar 2020 18:52:41 -0800 (PST)
Received: from mStation (host224-250-dynamic.8-87-r.retail.telecomitalia.it.
 [87.8.250.224])
 by smtp.gmail.com with ESMTPSA id a7sm26116659wrm.29.2020.03.01.18.52.39
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 01 Mar 2020 18:52:40 -0800 (PST)
Date: Mon, 2 Mar 2020 03:52:38 +0100 (CET)
From: Enrico Mioso <mrkiko.rs@gmail.com>
X-X-Sender: mrkiko@mStation.localdomain
To: openwrt-devel@lists.openwrt.org
In-Reply-To: <alpine.LNX.2.21.99999.353.2003020342120.1019928@mStation.localdomain>
Message-ID: <alpine.LNX.2.21.99999.353.2003020351580.1019950@mStation.localdomain>
References: <alpine.LNX.2.21.99999.353.2003020317090.1019877@mStation.localdomain>
 <alpine.LNX.2.21.99999.353.2003020342120.1019928@mStation.localdomain>
MIME-Version: 1.0
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200301_185243_559003_4B0B24DA 
...
X-Spam-Report: SpamAssassin version 3.4.3 on bombadil.infradead.org summary:
 ...
 service
Subject: Re: [OpenWrt-Devel] jffs2: Erase at 0x01ab0000 failed immediately:
...
> To: openwrt-devel@lists.openwrt.org
> Cc: Neil Brown <neilb@suse.de>
> Subject: Re: jffs2: Erase at 0x01ab0000 failed immediately: errno -22 on
>     ZBT-WG3526 (32M)
> 
> Ok guys, the error rpeats itself, and jffs2 seems to get corrupted. And even 
> erasing the mtd6 device fails at some point.
> Even the F2FS filesystem on the internal SSD does corrupt. This remembers me 
> the issue I was having when using the GnuBee PC 1 some time ago.
...
> On Mon, 2 Mar 2020, Enrico Mioso wrote:
>
>> Date: Mon, 2 Mar 2020 03:20:40
>> From: Enrico Mioso <mrkiko.rs@gmail.com>
>> To: openwrt-devel@lists.openwrt.org
>> Subject: jffs2: Erase at 0x01ab0000 failed immediately: errno -22 on
>>     ZBT-WG3526 (32M)
>> 
>> Hi! I flashed OpenWRt master (commit 
>> 4349d4c6823bfe09caabbdd3c9a65198addc76d6) on this device. All seems to work 
>> fine, but I sawthis in the dmesg.
>> 
...
>> 
>> full dmesg:
>> [    0.000000] Linux version 4.14.171 (mrkiko@mStation) (gcc version 8.3.0 
>> (OpenWrt GCC 8.3.0 r12417-4349d4c682)) #0 SMP Sun Mar 1 22:39:27 2020
...
>> [    0.000000] free_area_init_node: node 0, pgdat 805f8360, node_mem_map 
>> 81003000
>> [    0.000000]   Normal zone: 576 pages used for memmap
>> [    0.000000]   Normal zone: 0 pages reserved
>> [    0.000000]   Normal zone: 65536 pages, LIFO batch:15
>> [    0.000000]   HighMem zone: 65536 pages, LIFO batch:15
>> [    0.000000] random: get_random_bytes called from start_kernel+0x9c/0x4d8 
>> with crng_init=0
...
>> [    0.000000] pcpu-alloc: [0] 0 [0] 1 [0] 2 [0] 3 [    0.000000] Built 1 
>> zonelists, mobility grouping on.  Total pages: 130496
...
>> [    0.000000] Memory: 510976K/524288K available (4819K kernel code, 244K 
>> rwdata, 1048K rodata, 1236K init, 253K bss, 13312K reserved, 0K 
...
>> [    0.000010] sched_clock: 32 bits at 440MHz, resolution 2ns, wraps every 
>> 4880645118ns
...
>> [    0.085307] Mountpoint-cache hash table entries: 1024 (order: 0, 4096 
>> bytes)
>> [    0.094587] Hierarchical SRCU implementation.
>> [    0.099822] smp: Bringing up secondary CPUs ...
>> [    0.105966] Primary instruction cache 32kB, VIPT, 4-way, linesize 32 
>> bytes.
>> [    0.105975] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 
>> 32 bytes
...
>> [    0.206013] Primary instruction cache 32kB, VIPT, 4-way, linesize 32 
>> bytes.
>> [    0.206021] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 
>> 32 bytes
...
>> [    0.287157] Primary instruction cache 32kB, VIPT, 4-way, linesize 32 
>> bytes.
>> [    0.287165] Primary data cache 32kB, 4-way, PIPT, no aliases, linesize 
>> 32 bytes
...
>> [    0.379150] clocksource: jiffies: mask: 0xffffffff max_cycles: 
...
>> [    1.924629] PCI coherence region base: 0xbfbf8000, mask/settings: 
>> 0x60000000
...
>> [    1.972045] pci_bus 0000:00: root bus resource [mem 
>> 0x60000000-0x6fffffff]
>> [    1.978812] pci_bus 0000:00: root bus resource [io  0xffffffff]
>> [    1.984709] pci_bus 0000:00: root bus resource [??? 0x00000000 flags 
>> 0x0]
>> [    1.991433] pci_bus 0000:00: No busn resource found for root bus, will 
>> use [bus 00-ff]
...
>> [    2.001485] pci 0000:02:00.0: reg 0x10: [mem 0x00000000-0x000fffff 
>> 64bit]
...
>> [    2.009184] pci 0000:00:00.0: BAR 0: failed to assign [mem size 
>> 0x80000000]
>> [    2.016154] pci 0000:00:01.0: BAR 0: no space for [mem size 0x80000000]
>> [    2.022661] pci 0000:00:01.0: BAR 0: failed to assign [mem size 
>> 0x80000000]
>> [    2.029599] pci 0000:00:02.0: BAR 0: no space for [mem size 0x80000000]
>> [    2.036146] pci 0000:00:02.0: BAR 0: failed to assign [mem size 
>> 0x80000000]
>> [    2.043082] pci 0000:00:00.0: BAR 8: assigned [mem 
>> 0x60000000-0x600fffff]
>> [    2.049796] pci 0000:00:01.0: BAR 8: assigned [mem 
>> 0x60100000-0x601fffff]
>> [    2.056554] pci 0000:00:01.0: BAR 9: assigned [mem 0x60200000-0x602fffff 
>> pref]
>> [    2.063704] pci 0000:00:02.0: BAR 8: assigned [mem 
>> 0x60300000-0x603fffff]
>> [    2.070468] pci 0000:00:02.0: BAR 9: assigned [mem 0x60400000-0x604fffff 
>> pref]
>> [    2.077622] pci 0000:00:00.0: BAR 1: assigned [mem 
>> 0x60500000-0x6050ffff]
>> [    2.084385] pci 0000:00:01.0: BAR 1: assigned [mem 
>> 0x60510000-0x6051ffff]
>> [    2.091099] pci 0000:00:02.0: BAR 1: assigned [mem 
>> 0x60520000-0x6052ffff]
...
>> [    2.110649] pci 0000:01:00.0: BAR 0: assigned [mem 
>> 0x60000000-0x600fffff]
>> [    2.117367] pci 0000:00:00.0: PCI bridge to [bus 01]
>> [    2.122309] pci 0000:00:00.0:   bridge window [mem 
>> 0x60000000-0x600fffff]
>> [    2.129034] pci 0000:02:00.0: BAR 0: assigned [mem 0x60100000-0x601fffff 
>> 64bit]
>> [    2.136311] pci 0000:02:00.0: BAR 6: assigned [mem 0x60200000-0x6020ffff 
>> pref]
>> [    2.143449] pci 0000:00:01.0: PCI bridge to [bus 02]
>> [    2.148397] pci 0000:00:01.0:   bridge window [mem 
>> 0x60100000-0x601fffff]
>> [    2.155113] pci 0000:00:01.0:   bridge window [mem 0x60200000-0x602fffff 
>> pref]
>> [    2.162321] pci 0000:03:00.0: BAR 6: assigned [mem 0x60400000-0x6040ffff 
>> pref]
>> [    2.169461] pci 0000:03:00.0: BAR 5: assigned [mem 
>> 0x60300000-0x603001ff]
...
>> [    2.245057] pci 0000:00:02.0:   bridge window [mem 
>> 0x60300000-0x603fffff]
>> [    2.251823] pci 0000:00:02.0:   bridge window [mem 0x60400000-0x604fffff 
>> pref]
>> [    2.260578] clocksource: Switched to clocksource GIC
>> [    2.267445] NET: Registered protocol family 2
>> [    2.272412] TCP established hash table entries: 2048 (order: 1, 8192 
>> bytes)
...
>> [    2.569467] jffs2: version 2.2 (NAND) (SUMMARY) (LZMA) (RTIME) 
...
>> [    2.608110] 1e000c00.uartlite: ttyS0 at MMIO 0x1e000c00 (irq = 19, 
>> base_baud = 3125000) is a 16550A
>> [    2.617182] console [ttyS0] enabled
>> [    2.624065] bootconsole [early0] disabled
>> [    2.634362] MediaTek Nand driver init, version v2.1 Fix AHB virt2phys 
>> error
...
>> [    4.223693] mtk_soc_eth 1e100000.ethernet eth0: mediatek frame engine at 
>> 0xbe100000, irq 22
...
>> [    4.268945] VFS: Mounted root (squashfs filesystem) readonly on device 
>> 31:5.
...
>> [    7.139026] kmodloader: loading kernel modules from 
>> /etc/modules-boot.d/*
...
>> [    7.389239] ahci 0000:03:00.0: AHCI 0001.0200 32 slots 2 ports 6 Gbps 
>> 0x3 impl IDE mode
>> [    7.397240] ahci 0000:03:00.0: flags: 64bit ncq sntf stag led clo pmp 
>> pio slum part ccc sxs [    7.407968] scsi host0: ahci
>> [    7.411615] scsi host1: ahci
>> [    7.414789] ata1: SATA max UDMA/133 abar m512@0x60300000 port 0x60300100 
>> irq 26
>> [    7.422101] ata2: SATA max UDMA/133 abar m512@0x60300000 port 0x60300180 
>> irq 26
>> [    7.770593] ata1: SATA link down (SStatus 0 SControl 300)
>> [    8.110583] ata2: SATA link up 6.0 Gbps (SStatus 133 SControl 300)
>> [    8.117043] ata2.00: ATA-9: WDC WDS120G2G0A-00JH30, UE450000, max 
>> UDMA/133
>> [    8.123907] ata2.00: 234455040 sectors, multi 1: LBA48 NCQ (depth 31/32)
>> [    8.136074] ata2.00: configured for UDMA/133
>> [    8.141072] scsi 1:0:0:0: Direct-Access     ATA      WDC WDS120G2G0A- 
>> 0000 PQ: 0 ANSI: 5
>> [    8.151374] sd 1:0:0:0: [sda] 234455040 512-byte logical blocks: (120 
>> GB/112 GiB)
>> [    8.158945] sd 1:0:0:0: [sda] Write Protect is off
>> [    8.163738] sd 1:0:0:0: [sda] Mode Sense: 00 3a 00 00
>> [    8.163930] sd 1:0:0:0: [sda] Write cache: enabled, read cache: enabled, 
>> doesn't support DPO or FUA
>> [    8.175472]  sda: sda1
>> [    8.179936] sd 1:0:0:0: [sda] Attached SCSI disk
>> [    8.191138] xhci-mtk 1e1c0000.xhci: 1e1c0000.xhci supply vbus not found, 
>> using dummy regulator
>> [    8.199866] xhci-mtk 1e1c0000.xhci: 1e1c0000.xhci supply vusb33 not 
>> found, using dummy regulator
>> [    8.208828] xhci-mtk 1e1c0000.xhci: xHCI Host Controller
>> [    8.214173] xhci-mtk 1e1c0000.xhci: new USB bus registered, assigned bus 
>> number 1
>> [    8.230756] xhci-mtk 1e1c0000.xhci: hcc params 0x01401198 hci version 
>> 0x96 quirks 0x0000000000210010
...
>> [    8.260669] xhci-mtk 1e1c0000.xhci: new USB bus registered, assigned bus 
>> number 2
>> [    8.268136] xhci-mtk 1e1c0000.xhci: Host supports USB 3.0  SuperSpeed
>> [    8.274792] usb usb2: We don't know the algorithms for LPM for this 
>> host, disabling LPM.
>> [    8.283784] hub 2-0:1.0: USB hub found
>> [    8.287609] hub 2-0:1.0: 1 port detected
>> [    8.364965] kmodloader: done loading kernel modules from 
>> /etc/modules-boot.d/*
>> [    8.380970] init: - preinit -
>> [    8.410283] mmc0: new high speed SDHC card at address 0001
>> [    8.416874] mmcblk0: mmc0:0001 SD16G 14.5 GiB [    8.422931]  mmcblk0: 
>> p1
...
>> [   13.968763] jffs2: notice: (560) jffs2_build_xattr_subsystem: complete 
>> building xattr subsystem, 3 of xdatum (0 unchecked, 1 orphan) and 3 of xref 
...
>> [   14.119024] mtk_soc_eth 1e100000.ethernet: 0x100 = 0x6060000c, 0x10c = 
>> 0x80818
...
>> [   17.452781] Loading modules backported from Linux version 
...
>> [   17.595893] wireguard: WireGuard 0.0.20200215 loaded. See 
>> www.wireguard.com for information.
>> [   17.604380] wireguard: Copyright (C) 2015-2019 Jason A. Donenfeld 
...
>> [   19.419817] ieee80211 phy0: Selected rate control algorithm 
>> 'minstrel_ht'
...
>> [   20.298547] ieee80211 phy1: Selected rate control algorithm 
>> 'minstrel_ht'
...
>> [   20.328030] qmi_wwan 1-2:1.4 wwan0: register 'qmi_wwan' at 
>> usb-1e1c0000.xhci-2, WWAN/QMI device, 22:7f:81:5d:34:75
>> [   20.338730] usbcore: registered new interface driver qmi_wwan
>> [   20.348443] usbcore: registered new interface driver option
>> [   20.354278] usbserial: USB Serial support registered for GSM modem 
>> (1-port)
>> [   20.361751] option 1-2:1.0: GSM modem (1-port) converter detected
>> [   20.368264] usb 1-2: GSM modem (1-port) converter now attached to 
>> ttyUSB0
>> [   20.375698] option 1-2:1.1: GSM modem (1-port) converter detected
>> [   20.382345] usb 1-2: GSM modem (1-port) converter now attached to 
>> ttyUSB1
>> [   20.389722] option 1-2:1.2: GSM modem (1-port) converter detected
>> [   20.396328] usb 1-2: GSM modem (1-port) converter now attached to 
>> ttyUSB2
>> [   20.403725] option 1-2:1.3: GSM modem (1-port) converter detected
>> [   20.410289] usb 1-2: GSM modem (1-port) converter now attached to 
>> ttyUSB3
>> [   20.420910] kmodloader: done loading kernel modules from 
>> /etc/modules.d/*
