...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 77087D9C0D
	for <lists+openwrt-devel@lfdr.de>; Wed, 16 Oct 2019 22:56:07 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=R1c0e+yUyQzNF+m1SOeA31cQAcB2NCHQABe25wI5ANo=; b=poqdOHWlv2Jo0V
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iKqKr-0002Te-Bm; Wed, 16 Oct 2019 20:55:57 +0000
Received: from mx4.wp.pl ([212.77.101.11])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iKqKW-0002HJ-4l
 for openwrt-devel@lists.openwrt.org; Wed, 16 Oct 2019 20:55:38 +0000
Received: (wp-smtpd smtp.wp.pl 4142 invoked from network);
 16 Oct 2019 22:55:32 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=wp.pl; s=1024a;
 t=1571259332; bh=1/XnyyjHDocBFbC2JrAjjYHR1ypjHv29hgohzhSKx6Q=;
 h=From:To:Cc:Subject;
 b=uHcbTaa3a7hk/7ipumcWto5f6iddcF0b2SL3zdwTz8sYMh52Iy6rWseVfZOStd2c6
 uIuIBfzkAd51OdJYcNt3wddx4EgH5XvL5TXUulEah85nRLtPkWM23n3jfhrhQvvr9T
 83YfznDDUerNFNm/7feX17unYM0orwEMdVhOZKJo=
Received: from 89-79-49-72.dynamic.chello.pl (HELO kosmio.komorska)
 (michal.cieslakiewicz@wp.pl@[89.79.49.72])
 (envelope-sender <michal.cieslakiewicz@wp.pl>)
 by smtp.wp.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
 for <openwrt-devel@lists.openwrt.org>; 16 Oct 2019 22:55:32 +0200
Date: Wed, 16 Oct 2019 12:42:44 +0200
From: Michal Cieslakiewicz <michal.cieslakiewicz@wp.pl>
To: "openwrt-devel@lists.openwrt.org" <openwrt-devel@lists.openwrt.org>
Message-ID: <20191016124244.02400fb8@kosmio.komorska>
In-Reply-To: <20191016123722.70774de1@kosmio.komorska>
References: <20191016123722.70774de1@kosmio.komorska>
X-Mailer: Claws Mail 3.17.1 (GTK+ 2.24.32; x86_64-slackware-linux-gnu)
MIME-Version: 1.0
X-WP-MailID: fc7b8a934b6029445e5e5c200935dee2
X-WP-AV: skaner antywirusowy Poczty Wirtualnej Polski
X-WP-SPAM: NO 0000000 [QcN1]                               
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191016_135536_727545_F5843944 
...
X-Spam-Report: SpamAssassin version 3.4.2 on bombadil.infradead.org summary:
 ...
 valid
Subject: [OpenWrt-Devel] [PATCH v5 4/5] ath79: add support for Netgear
 WNR1000 v2
...
index 97598ce45c..499fe0031c 100755
--- a/target/linux/ath79/base-files/etc/board.d/01_leds
+++ b/target/linux/ath79/base-files/etc/board.d/01_leds
@@ -111,6 +111,7 @@ glinet,gl-ar300m-lite)
 glinet,gl-x750)
...
index 72ee6279ea..8efab146f2 100755
...
index fb37bd8579..104e77ac3f 100644
