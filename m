...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B36E8339C
	for <lists+openwrt-devel@lfdr.de>; Tue,  6 Aug 2019 16:09:45 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=OWYcnbvTBRdQqLit/rPahagEtXzH6LuODJDjZ4xDSvo=; b=VDBvOlBVfYFMmE
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hv09d-0003NX-4C; Tue, 06 Aug 2019 14:09:33 +0000
Received: from mx4.wp.pl ([212.77.101.12])
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1hv099-0002w3-69
 for openwrt-devel@lists.openwrt.org; Tue, 06 Aug 2019 14:09:04 +0000
Received: (wp-smtpd smtp.wp.pl 20076 invoked from network);
 6 Aug 2019 16:09:00 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=wp.pl; s=1024a;
 t=1565100540; bh=nzjhF1sSYfrOkzZtuwsuIUsVT1ffl4p/X8rPpixZuXI=;
 h=From:To:Cc:Subject;
 b=Cpcbq8GVKFgSpF4RJumKawNHX8mj2yi+7dCY26Q4xcli30QqeKwwj+sn4rAE35wGG
 n+DbwxYAuXcpBiZCILZ/8AVNGVsmXiUiEzb67jXmgMdAiN3bUsn5AHXU9k9zQ9yfop
 jN+QP8VJlxMUPpItNKsqX2L5igZFA0x/zchb3y7M=
Received: from 89-79-49-72.dynamic.chello.pl (HELO kosmio.komorska)
 (michal.cieslakiewicz@wp.pl@[89.79.49.72])
 (envelope-sender <michal.cieslakiewicz@wp.pl>)
 by smtp.wp.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
 for <openwrt-devel@lists.openwrt.org>; 6 Aug 2019 16:09:00 +0200
Date: Tue, 6 Aug 2019 15:55:40 +0200
From: Michal Cieslakiewicz <michal.cieslakiewicz@wp.pl>
To: "openwrt-devel@lists.openwrt.org" <openwrt-devel@lists.openwrt.org>
Message-ID: <20190806155540.4e27407b@kosmio.komorska>
X-Mailer: Claws Mail 3.17.1 (GTK+ 2.24.32; x86_64-slackware-linux-gnu)
MIME-Version: 1.0
X-WP-MailID: 8871fd274219a700331992703cee2801
X-WP-AV: skaner antywirusowy Poczty Wirtualnej Polski
X-WP-SPAM: NO 000000A [McOU]                               
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190806_070903_418806_1ED46696 
...
Subject: [OpenWrt-Devel] [PATCH v2 0/5] ath79: add support for some Netgear
 WNR routers
