...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id AE92118A92
	for <lists+openwrt-devel@lfdr.de>; Thu,  9 May 2019 15:28:13 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=cm0PcF6qVNdh5YjpBtMdxL7+5mT8vmDfig0sNHi5t7c=; b=hxS4E+XLpYSzGGHvPxc8Gjhcr0
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.90_1 #2 (Red Hat Linux))
	id 1hOj5h-0007TJ-8Y; Thu, 09 May 2019 13:28:05 +0000
Received: from mx-out.tlen.pl ([193.222.135.148])
 by bombadil.infradead.org with esmtps (Exim 4.90_1 #2 (Red Hat Linux))
 id 1hOj4n-0006CE-PK
 for openwrt-devel@lists.openwrt.org; Thu, 09 May 2019 13:27:27 +0000
Received: (wp-smtpd smtp.tlen.pl 31327 invoked from network);
 9 May 2019 15:27:00 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=o2.pl; s=1024a;
 t=1557408421; bh=zyOdicVByqkbNIfwxVzUYUYDaWs2GnHJDH+xeQYuAt0=;
 h=From:To:Subject;
 b=ZOAxK+fziq8WWw8VWwHkl5gnmoBfJ2uGnd8sifWblmQqyJSNU18gUhzcZu5Kq4tb0
 wbVzCcm1hSIEsj7PRU2YqiEcnC5XdiBgygL22MFPHSzClmgxeMHDKSMOVVPHr8LYa6
 FeK6YPiIwNzho5Yjhe4tozNjNE8H6icW/2SM+m/I=
Received: from 131.ip-164-132-48.eu (HELO localhost.localdomain)
 (tomek_n@o2.pl@[164.132.48.131]) (envelope-sender <tomek_n@o2.pl>)
 by smtp.tlen.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
 for <openwrt-devel@lists.openwrt.org>; 9 May 2019 15:27:00 +0200
From: Tomasz Maciej Nowak <tomek_n@o2.pl>
To: openwrt-devel@lists.openwrt.org
Date: Thu,  9 May 2019 15:26:27 +0200
Message-Id: <20190509132628.4671-8-tomek_n@o2.pl>
X-Mailer: git-send-email 2.21.0
In-Reply-To: <20190509132628.4671-1-tomek_n@o2.pl>
References: <20190509132628.4671-1-tomek_n@o2.pl>
MIME-Version: 1.0
X-WP-MailID: a4bd4b4cccb90e1d8f57963487c04129
X-WP-AV: skaner antywirusowy Poczty o2
X-WP-SPAM: NO 0000000 [sQNk]                               
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190509_062711_175321_97C1547B 
...
Subject: [OpenWrt-Devel] [PATCH v2 7/8] mvebu: use device-tree board
 detection
...
---
 ...
 17 files changed, 86 insertions(+), 179 deletions(-)
