...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B8C91B16B6
	for <lists+openwrt-devel@lfdr.de>; Mon, 20 Apr 2020 22:10:47 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=JnqYE+PXILedRGAfp8JbYPhEgP1wawOt/ggGFa0q17A=; b=obnHbIAKl2cI8QwfL9ItE+ZCD
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jQckd-0006cg-4l; Mon, 20 Apr 2020 20:10:43 +0000
Received: from mxout02.bytecamp.net ([212.204.60.218])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jQckV-0006bF-HH
 for openwrt-devel@lists.openwrt.org; Mon, 20 Apr 2020 20:10:36 +0000
Received: by mxout02.bytecamp.net (Postfix, from userid 1001)
 id 1BF405D33A; Mon, 20 Apr 2020 22:10:33 +0200 (CEST)
Received: from mail.bytecamp.net (mail.bytecamp.net [212.204.60.9])
 by mxout02.bytecamp.net (Postfix) with ESMTP id BE4B75D338
 for <openwrt-devel@lists.openwrt.org>; Mon, 20 Apr 2020 22:10:33 +0200 (CEST)
Received: (qmail 20880 invoked from network); 20 Apr 2020 22:10:33 +0200
Received: from unknown (HELO ?10.11.12.7?) (jo%wwsnet.net@95.90.36.22)
 by mail.bytecamp.net with ESMTPS (AES128-SHA encrypted);
 20 Apr 2020 22:10:33 +0200
To: openwrt-devel@lists.openwrt.org
References: <02b901d6174b$d6a6f3e0$83f4dba0$@adrianschmutzler.de>
 <5c33dac6-9223-8f75-7d44-f5288aa9c7f8@wwsnet.net>
 <02d701d6174f$32fa0670$98ee1350$@adrianschmutzler.de>
...
Message-ID: <8d40cb4a-e880-ea7b-c85f-8382ff156e44@wwsnet.net>
Date: Mon, 20 Apr 2020 22:10:29 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.1
MIME-Version: 1.0
In-Reply-To: <02d701d6174f$32fa0670$98ee1350$@adrianschmutzler.de>
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200420_131035_733503_B13CC62E 
...
Content-Type: multipart/mixed; boundary="===============4115862398054340344=="
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="5Oi2LrryhqGN2upkEfluMC3Ye1VbIGFNF"

This is an OpenPGP/MIME signed message (RFC 4880 and 3156)
--5Oi2LrryhqGN2upkEfluMC3Ye1VbIGFNF
Content-Type: multipart/mixed; boundary="HM5m1XXk5ETnTSqwWDTjCzbevHFLAVdFq";
...
--HM5m1XXk5ETnTSqwWDTjCzbevHFLAVdFq
...
> Note that DSA devices might have additional separate devices labelled e=
thX
...
>=20
> So, this might become confusing quite quickly if we start to rename to =
ethY
> here.

Note that I wasn't proposing to use ethX as naming schema - I totally agr=
ee
that this would be confusing. I could've written:

  ucidef_add_dsa "sw0p1:wan" \
    "sw0p2:lan:4" "sw0p3:lan:3" "sw0p4:lan:2" "sw0p5:lan:1"
...

=0e/k
-----END PGP SIGNATURE-----
