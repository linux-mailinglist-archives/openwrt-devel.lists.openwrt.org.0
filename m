...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 3745E153541
	for <lists+openwrt-devel@lfdr.de>; Wed,  5 Feb 2020 17:31:40 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=3N50DwVOgdzgg/wEeaWQzlaG20egsqTYFTbf/L6UjC0=; b=sQnSiGyollF6mV
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1izNaP-0004p3-VE; Wed, 05 Feb 2020 16:31:33 +0000
Received: from achernar.uberspace.de ([95.143.172.237])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1izNaI-0004oR-Fq
 for openwrt-devel@lists.openwrt.org; Wed, 05 Feb 2020 16:31:28 +0000
Received: (qmail 11523 invoked from network); 5 Feb 2020 16:31:20 -0000
Received: from localhost (HELO ?IPv6:2a02:790:ff:1021:d5fd:9e25:3f6d:ec97?)
 (127.0.0.1)
 by achernar.uberspace.de with SMTP; 5 Feb 2020 16:31:20 -0000
...
Message-ID: <5b8d7be8-e551-869e-6e55-13233fd8baf8@ironai.com>
Date: Wed, 5 Feb 2020 17:31:16 +0100
User-Agent: Mozilla/5.0 (X11; Linux i686; rv:60.0) Gecko/20100101
 Thunderbird/60.6.1
MIME-Version: 1.0
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200205_083126_819447_4BCE409E 
...
Subject: [OpenWrt-Devel] ath79: Let the internal switch control the LEDs
...
is there any reason why OpenWrt does not let the switch control the LED activity?
E.g. with QCA9531 it's just setting the GPIO function register to a specific value
and if one wants a more OpenWrt-like blinking pattern configuring the switch registers.
