...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id B359F18A8C
	for <lists+openwrt-devel@lfdr.de>; Thu,  9 May 2019 15:27:41 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=SC2Ta5VVMsKVuI0SvNAPzllcZSOS/2WFzGV49esrgQs=; b=DA5oNrQ9TSAfqRL9MVjkpG2Kjb
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.90_1 #2 (Red Hat Linux))
	id 1hOj5B-0006ch-5K; Thu, 09 May 2019 13:27:33 +0000
Received: from mx-out.tlen.pl ([193.222.135.148])
 by bombadil.infradead.org with esmtps (Exim 4.90_1 #2 (Red Hat Linux))
 id 1hOj4a-0005wY-Vb
 for openwrt-devel@lists.openwrt.org; Thu, 09 May 2019 13:27:01 +0000
Received: (wp-smtpd smtp.tlen.pl 19839 invoked from network);
 9 May 2019 15:26:52 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=o2.pl; s=1024a;
 t=1557408413; bh=ObPoMDrMC0tkL4+EpMcxCCLPMUmgjIlHq39ofGUn0cw=;
 h=From:To:Subject;
 b=W9kVEQBOK/WYRmqizBlD6lyP51siYg8wmEzdXhA8vLsAg4P5r7yxsjZACeIZD3pG8
 55ZotX870nKpqHID45PLG75qxF2HL5XI8Vevy7+nY1vNukKusieN8oRSYjatDWih7r
 GPv3a/zJO6eIZFAjOq31Mlm+nGJsUBVQ/nhRPyT8=
Received: from 131.ip-164-132-48.eu (HELO localhost.localdomain)
 (tomek_n@o2.pl@[164.132.48.131]) (envelope-sender <tomek_n@o2.pl>)
 by smtp.tlen.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
 for <openwrt-devel@lists.openwrt.org>; 9 May 2019 15:26:52 +0200
From: Tomasz Maciej Nowak <tomek_n@o2.pl>
To: openwrt-devel@lists.openwrt.org
Date: Thu,  9 May 2019 15:26:24 +0200
Message-Id: <20190509132628.4671-5-tomek_n@o2.pl>
X-Mailer: git-send-email 2.21.0
In-Reply-To: <20190509132628.4671-1-tomek_n@o2.pl>
References: <20190509132628.4671-1-tomek_n@o2.pl>
MIME-Version: 1.0
X-WP-MailID: dde86e3ee76009ab145e466d600dbf4f
X-WP-AV: skaner antywirusowy Poczty o2
X-WP-SPAM: NO 0000000 [YWNE]                               
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190509_062657_450919_0F9F4541 
...
Subject: [OpenWrt-Devel] [PATCH v2 4/8] mvebu: image: improve readability of
 device recipes
