...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 054391BD6B3
	for <lists+openwrt-devel@lfdr.de>; Wed, 29 Apr 2020 09:58:37 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=e2NYsRmqzfsUH7ZDwrbhKBlqageKJvc1FUli/XLL5Uw=; b=Bkv3LxX0IzWpCaLChbehOMy78
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jThc1-0007hQ-B6; Wed, 29 Apr 2020 07:58:33 +0000
Received: from mail-ej1-x635.google.com ([2a00:1450:4864:20::635])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jThbq-0007fe-EO
 for openwrt-devel@lists.openwrt.org; Wed, 29 Apr 2020 07:58:24 +0000
Received: by mail-ej1-x635.google.com with SMTP id s3so809211eji.6
 for <openwrt-devel@lists.openwrt.org>; Wed, 29 Apr 2020 00:58:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=5YPifK4Ps2i1GW9hsWC56UAWLeaOAJembr2ilknWkVI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=5YPifK4Ps2i1GW9hsWC56UAWLeaOAJembr2ilknWkVI=;
 b=
X-Gm-Message-State: AGi0PuZUFGQR0zNykE4QWVWY5D/8B3djgGqL93H6Sll/CawgVg5GBwLa
 RNcV7ncZ57Dg8ITjZ7yQCzf8G2uURGKH4tBjoCAGakSR
X-Google-Smtp-Source: APiQypIsPTZ74DNHORTRJ+mTpGWhcpPFmXwJT56t1wLzHbW+JxQl/AVfwtJ0V4lbSNcnr225vKBf+yvJBaMZyLFhQTk=
X-Received: by 2002:a17:907:214f:: with SMTP id
 rk15mr1415808ejb.301.1588147100897; 
 Wed, 29 Apr 2020 00:58:20 -0700 (PDT)
MIME-Version: 1.0
...
Date: Wed, 29 Apr 2020 16:58:09 +0900
Message-ID: <CALYKT1h6m+hQM+oWZ24KkKiiVD5AfLD5T3gwB_aN30AZvdBmGA@mail.gmail.com>
To: Michael Jones <mike@meshplusplus.com>
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200429_005822_489637_337D331A 
...
X-Spam-Report: SpamAssassin version 3.4.4 on bombadil.infradead.org summary:
 ...
 no trust [2a00:1450:4864:20:0:0:0:635 listed in]
 [list.dnswl.org]
...
Content-Type: multipart/mixed; boundary="===============3227988802258739138=="
Sender: "openwrt-devel" <openwrt-devel-bounces@lists.openwrt.org>
Errors-To: openwrt-devel-bounces+lists+openwrt-devel=lfdr.de@lists.openwrt.org

--===============3227988802258739138==
Content-Type: multipart/alternative; boundary="000000000000ccd5e205a4694f97"

--000000000000ccd5e205a4694f97
...
2020=EB=85=84 4=EC=9B=94 29=EC=9D=BC (=EC=88=98) =EC=98=A4=ED=9B=84 3:58, M=
...
>> usbnet_adapter                                      : /sys/class/net/wwa=
n0
...
>> qmi_wwan                6252  0
>> usbcore               153512 20
>> option,usb_wwan,qmi_wwan,cdc_ncm,cdc_ether,usbserial,usbnet,usblp,cdc_wd=
m,cdc_acm,usb_storage,xhci_mtk,xhci_plat_hcd,xhci_pci,xhci_hcd,uhci_hcd,ohc=
i_platform,ohci_hcd,ehci_platform,ehci_hcd
...
>> guessed that opensource ModemManager infrastructure would give us some s=
ort
>> of independence from specific modem and in other words it would give som=
e
>> abstraction..
>>
>> I am not sure of anything. Could someone give me some light so that I ca=
n
...
>>
>>
> Is it practical for you to upgrade to a newer version of OpenWRT? 17.01 i=
s
> pretty old
>
> But  since I've been dealing with modem manager related problems in my ow=
n
...
<div dir=3D"ltr">Hello Michael,<div><br></div><div>I will keep in mind your=
 message about mmcli and netifd.</div><div>And thank you for letting me kno=
w the ModemManager project urls.</div><div><br></div><div>Thank you very mu=
ch!</div><div>Jeonghum</div></div><br><div class=3D"gmail_quote"><div dir=
=3D"ltr" class=3D"gmail_attr">2020=EB=85=84 4=EC=9B=94 29=EC=9D=BC (=EC=88=
=98) =EC=98=A4=ED=9B=84 3:58, Michael Jones &lt;<a href=3D"mailto:mike@mesh=
plusplus.com">mike@meshplusplus.com</a>&gt;=EB=8B=98=EC=9D=B4 =EC=9E=91=EC=
...
=3D"ltr" class=3D"gmail_attr">On Wed, Apr 29, 2020 at 1:30 AM Jeonghum Joh =
&lt;<a href=3D"mailto:oosaprogrammer@gmail.com" target=3D"_blank">oosaprogr=
ammer@gmail.com</a>&gt; wrote:<br></div><blockquote class=3D"gmail_quote" s=
tyle=3D"margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);pad=
ding-left:1ex"><div dir=3D"ltr">Hello,<div>Thanks to many people in this li=
st, I was able to find ModemManager and I&#39;ve tried applying it.</div><d=
iv><br></div><div>=3D=3D=3D=3D Testing environment =3D=3D=3D=3D</div><div><=
br></div><div>Target Model=C2=A0 =C2=A0 =C2=A0 =C2=A0 : MediaTek MT7622 AC4=
300rfb1 board<br></div><div>Firmware Version : LEDE Reboot 17.01-SNAPSHOT u=
nknown / LuCI</div><div>Kernel Version=C2=A0 =C2=A0 =C2=A0 : 4.4.124</div><=
div>Modem=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0: HU=
COM HM-900<br></div><div>ModemManager<br></div><div>Version=C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0: 1.12.8<br></div><div>menu=
config=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 : (QMI on, MBIM off)</div><div>git=
 clone URL=C2=A0 =C2=A0 =C2=A0 =C2=A0 :=C2=A0<a href=3D"https://github.com/=
openwrt/packages/tree/master/net/modemmanager" target=3D"_blank">https://gi=
thub.com/openwrt/packages/tree/master/net/modemmanager</a><br></div><div><b=
r></div><div>Noted Device Files : Those files and paths are noted/watched</=
div><div>qmichannel=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 : /dev/cdc-wdm0</div><div>usbnet_adapter=C2=A0 =C2=
=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =
=C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 =C2=A0 : /sys/class/net/wwan0</di=
v><div>/sys/bus/usb/devices/2-1/manufacturer : QCOM<br></div><div>/sys/bus/=
usb/devices/2-1/idVendor=C2=A0 =C2=A0 =C2=A0 =C2=A0 :05C6</div><div>
...
//gitlab.freedesktop.org/mobile-broadband/ModemManager" target=3D"_blank">h=
ttps://gitlab.freedesktop.org/mobile-broadband/ModemManager</a>, or on thei=
r mailing list=C2=A0<a href=3D"https://lists.freedesktop.org/mailman/listin=
fo/modemmanager-devel" target=3D"_blank">https://lists.freedesktop.org/mail=
man/listinfo/modemmanager-devel</a></div><div><br></div><div><br></div></di=
v></div>
</blockquote></div>
