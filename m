...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id B4113E9AF7
	for <lists+openwrt-devel@lfdr.de>; Wed, 30 Oct 2019 12:41:16 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=pevEbxC8x1hfkM9Ft3HxtzMqKy3I9ccpezqOLG5/DHs=; b=umV2Cx15cAMZgZ
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iPmLf-0007o0-UX; Wed, 30 Oct 2019 11:41:11 +0000
Received: from mx3.wp.pl ([212.77.101.10])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iPmLI-0007ao-85
 for openwrt-devel@lists.openwrt.org; Wed, 30 Oct 2019 11:40:51 +0000
Received: (wp-smtpd smtp.wp.pl 27362 invoked from network);
 30 Oct 2019 12:40:42 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=wp.pl; s=1024a;
 t=1572435642; bh=YYStJMNb3fSFYliY2ItpGGDGczaOgPG8gLFG9yFb2sY=;
 h=From:To:Cc:Subject;
 b=xCjC45meXdLMJjaTnx4VxQHcfNBxfsEEC2wSimtDw9+TUFqg4M7IfZRfFQ4sR6U0T
 dXu3wdFgKWqKvNhNpnUBiNQIRBE3k1I6BxS1Lc1pnNYhun+gTM8kOEsqXqfmbH/sFf
 7hnBG/6nRP+2jAhLiiMpaGO3vPisA9LE0h7L2Oko=
Received: from 89-79-49-72.dynamic.chello.pl (HELO kosmio.komorska)
 (michal.cieslakiewicz@wp.pl@[89.79.49.72])
 (envelope-sender <michal.cieslakiewicz@wp.pl>)
 by smtp.wp.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
 for <openwrt-devel@lists.openwrt.org>; 30 Oct 2019 12:40:42 +0100
Date: Wed, 30 Oct 2019 12:32:21 +0100
From: Michal Cieslakiewicz <michal.cieslakiewicz@wp.pl>
To: "openwrt-devel@lists.openwrt.org" <openwrt-devel@lists.openwrt.org>
Message-ID: <20191030123221.7a0af3ea@kosmio.komorska>
X-Mailer: Claws Mail 3.17.1 (GTK+ 2.24.32; x86_64-slackware-linux-gnu)
MIME-Version: 1.0
X-WP-MailID: 075a2aae4810a4480c55fddcdf6012ac
X-WP-AV: skaner antywirusowy Poczty Wirtualnej Polski
X-WP-SPAM: NO 0000000 [IQNh]                               
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191030_044048_983842_8AFEC2A5 
...
Subject: [OpenWrt-Devel] [PATCH v2] ath79: add support for Netgear WNDR4300
