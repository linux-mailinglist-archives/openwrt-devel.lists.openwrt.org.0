...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id A5F06159505
	for <lists+openwrt-devel@lfdr.de>; Tue, 11 Feb 2020 17:34:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=Pk0J6H2kLEA8Dz8a0yESxAJsAqbykS+MriAss2MoWq4=; b=eBPdTqzu6bvw3P
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j1YUu-0005HS-22; Tue, 11 Feb 2020 16:34:52 +0000
Received: from fudo.makrotopia.org ([2a07:2ec0:3002::71])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j1YUk-0005H8-Oj
 for openwrt-devel@lists.openwrt.org; Tue, 11 Feb 2020 16:34:44 +0000
Received: from local
 by fudo.makrotopia.org with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
 (Exim 4.92.2) (envelope-from <daniel@makrotopia.org>)
 id 1j1YUi-00063A-F2; Tue, 11 Feb 2020 17:34:41 +0100
Date: Tue, 11 Feb 2020 18:34:29 +0200
From: Daniel Golle <daniel@makrotopia.org>
To: openwrt-devel@lists.openwrt.org, Karl Palsson <karlp@tweak.net.au>
Message-ID: <20200211163429.GA405622@makrotopia.org>
...
X-CRM114-CacheID: sfid-20200211_083443_121571_3B522045 
...
Subject: [OpenWrt-Devel] [PATCH v3 2/2] ath79: add support for Teltonika
 RUT955
...
---
 ...
 ...1-tty-serial-ar933x-uart-rs485-gpio.patch} |   0
 5 files changed, 400 insertions(+)
 create mode 100644 target/linux/ath79/dts/ar9344_teltonika_rut955.dts
 rename target/linux/ath79/patches-4.19/{0041-tty-serial-ar933x-uart-rs485-gpio.patch => 0061-tty-serial-ar933x-uart-rs485-gpio.patch} (100%)

diff --git a/target/linux/ath79/dts/ar9344_teltonika_rut955.dts b/target/linux/ath79/dts/ar9344_teltonika_rut955.dts
new file mode 100644
index 0000000000..da778614a2
--- /dev/null
...
diff --git a/target/linux/ath79/patches-4.19/0041-tty-serial-ar933x-uart-rs485-gpio.patch b/target/linux/ath79/patches-4.19/0061-tty-serial-ar933x-uart-rs485-gpio.patch
similarity index 100%
rename from target/linux/ath79/patches-4.19/0041-tty-serial-ar933x-uart-rs485-gpio.patch
rename to target/linux/ath79/patches-4.19/0061-tty-serial-ar933x-uart-rs485-gpio.patch
-- 
2.25.0
